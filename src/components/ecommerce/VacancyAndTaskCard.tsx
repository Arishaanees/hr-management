...
export default function VacancyTaskSchedule() {
  const [openMenu, setOpenMenu] = useState<number | null>(null);
  const toggleMenu = (id: number) => setOpenMenu(openMenu === id ? null : id);

  const vacancies = [
    { id: 1, title: "Software Developer", type1: "Full-time", type2: "Remote", salary: "$70K - $90K / yr", applicants: "120 Applicants", iconBg: "bg-indigo-500/20 text-indigo-500" },
    { id: 2, title: "Graphic Designer", type1: "Part-time", type2: "Hybrid", salary: "$40K - $55K / yr", applicants: "75 Applicants", iconBg: "bg-lime-500/20 text-lime-500" },
    { id: 3, title: "Sales Manager", type1: "Full-time", type2: "On-site", salary: "$65K - $80K / yr", applicants: "75 Applicants", iconBg: "bg-yellow-500/20 text-yellow-500" },
    { id: 4, title: "HR Coordinator", type1: "Contract", type2: "Remote", salary: "$50K - $60K / yr", applicants: "60 Applicants", iconBg: "bg-purple-500/20 text-purple-500" },
  ];
  ...
  return (
    <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
      ...
      {/* ================= LEFT : VACANCIES ================= */}
      <div className="lg:col-span-8">
        <div className="rounded-2xl border bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 p-6">
          <div className="flex justify-between items-center mb-6">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-5">
            {vacancies.map((item) => (
              <div
                key={item.id}
                className="relative rounded-2xl border bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 p-5 hover:border-gray-300 dark:hover:border-gray-700 transition"
              >
                <div className="flex justify-between items-start">
                  <div className="flex gap-3">
                    ...
                    <div>
                      ...
                      <div className="flex gap-2 mt-1">
                        <span className="rounded-md bg-gray-100 dark:bg-gray-800 px-2 py-0.5 text-[11px] text-gray-500 dark:text-gray-400">
                          {item.type1}
                        </span>
                        <span className="rounded-md bg-gray-100 dark:bg-gray-800 px-2 py-0.5 text-[11px] text-gray-500 dark:text-gray-400">
                          {item.type2}
                  ...
                  <button onClick={() => toggleMenu(item.id)}>
                    <MoreDotIcon className="w-5 h-5 text-gray-500 dark:text-gray-400 hover:text-gray-700 dark:hover:text-gray-200" />
                  </button>

                  {openMenu === item.id && (
                    <div className="absolute right-3 top-9 z-20 w-28 rounded-lg border bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-700">
                      <button className="block w-full px-3 py-2 text-xs text-gray-700 dark:text-gray-300 hover:bg-gray-100 dark:hover:bg-gray-800 text-left">
                        View More
                      </button>
                      <button className="block w-full px-3 py-2 text-xs text-red-500 hover:bg-gray-100 dark:hover:bg-gray-800 text-left">
                        Delete
                      </button>
                    </div>
                  )}
        ...
        <div className="rounded-2xl border bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 p-6">
          ...
          <div className="space-y-4">
            {tasks.map((task, i) => (
              <div
                key={i}
                className="flex items-center gap-4 rounded-xl border bg-white dark:bg-gray-900 border-gray-200 dark:border-gray-800 p-3"
              >
                <div className="relative w-12 h-12">
                  <svg className="w-12 h-12 rotate-[-90deg]">
                    <circle
                    ...
                    <circle
                      ...
                      fill="none"
                      strokeDasharray={125}
                      strokeDashoffset={125 - (125 * task.percent) / 100}
                      strokeLinecap="round"
                    />
                  </svg>
